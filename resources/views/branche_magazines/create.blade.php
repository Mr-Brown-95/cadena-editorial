...
@section('contenido')
    ...
    <form action="/branches" method="POST">
        ...
        <div class="mb-3">
            ...
            <input id="ciudad" name="ciudad" type="text" class="form-control" tabindex="3" required>
        </div>
        <div class="mb-3">
            <label for="provincia" class="form-label">Provincia</label>
            <input id="provincia" name="provincia" type="text" class="form-control" tabindex="4" required>
        </div>
        <div class="mb-3">
